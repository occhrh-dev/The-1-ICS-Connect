...
var scale = zoom >= 15 ? 1 : zoom >= 13 ? 0.82 : zoom >= 11 ? 0.62 : zoom >= 8 ? 0.44 : 0.28;
...
var circle = null;
if (l.type === 'Staff') {
markerHtml = `<div class="custom-marker-box"><div class="c-marker-icon ${bgClass}"><i class="fas ${iconClass}"></i></div></div>`;
} else {
markerHtml = `
<div class="custom-marker-box">
<div class="c-marker-icon ${bgClass}"><i class="fas ${iconClass}"></i></div>
<div class="c-marker-label">${labelText}</div>
</div>
`;
