...
((typeof hasFeature === 'function' && !hasFeature('share_link'))
  ...
  : '<button type="button" onclick="window._zonePickerCallback=function(lat,lng){var l=document.getElementById(\'swal-eoc-lat\');var g=document.getElementById(\'swal-eoc-lng\');var s=document.getElementById(\'swal-eoc-coords-show\');if(l)l.value=lat;if(g)g.value=lng;if(s)s.textContent=\'📍 \'+lat+\', \'+lng;};mapPickerMode=\'zone\';openMap();" id="swal-eoc-map-btn" style="margin-top:4px;background:#1565c0;color:white;border:none;border-radius:6px;padding:5px 12px;cursor:pointer;font-size:0.8rem;font-weight:900;width:100%;"><i class="fas fa-map-marker-alt"></i> ปักหมุดที่ตั้ง EOC บนแผนที่ (ไม่บังคับ)</button>' +
